...
export default async function CategoryPage({ params }: CategoryPageProps) {
  ...
  const events = await prisma.event.findMany({
    ...
    take: 50, // Get more events for category page
  });
  ...
  return (
    <div className="min-h-screen text-gray-900 dark:text-gray-100">
      ...
      <main className="container mx-auto px-4 py-6">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 capitalize">{category} News</h1>
          <p className="text-gray-600 dark:text-gray-400">
            Latest {category.toLowerCase()} news and updates from multiple sources
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm">
              <h2 className="text-lg font-bold mb-4 text-red-600 dark:text-red-400">RECENT {category.toUpperCase()}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
          <div className="col-span-1 lg:col-span-9">
            <section className="mb-8">
              <h2 className="text-xl font-bold mb-4">All {category} News</h2>
