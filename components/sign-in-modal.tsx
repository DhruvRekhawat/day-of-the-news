        ...
        <DialogContent className="sm:max-w-md bg-gray-100 border-0 p-0 ">
          <div className="flex flex-col items-center px-8 py-6 space-y-6">
            ...
            <div className="text-center space-y-2">
              <h2 className="text-md font-semibold text-black">Sign In to Continue</h2>
              <p className="text-gray-600">Please enter your details to Sign In</p>
            </div>

            {/* Social Login Buttons */}
            <div className="flex space-x-4 w-full">
              <Button variant="outline" className="flex-1 h-12 bg-white border-gray-300 hover:bg-gray-50 rounded-none">
            ...
            <div className="w-full space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="joe@green@gmail.com"
            ...
            {/* Sign In Button */}
            <Button className="w-full h-12 bg-black text-white hover:bg-gray-800">Sign in</Button>
