...
export function BiasIndicator({ bias, size = "md", showLabel = false }: BiasIndicatorProps) {
  ...
  return (
    <div className="flex flex-col items-center space-y-1">
      ...
      <div className="relative">
        {/* Background bar */}
        <div className={cn("bg-gray-200 rounded-full", sizeClasses[size].bar)} />

        {/* Left section (blue) */}
        <div className="absolute top-0 left-0 bg-blue-500 rounded-l-full h-full" style={{ width: "33.33%" }} />
